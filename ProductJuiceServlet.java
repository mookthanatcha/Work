 ...
 * @author ADMIN
 */
public class ProductJuiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CategoryJpaController categoryJuiceJpa = new CategoryJpaController(utx, emf);

        Category category = categoryJuiceJpa.findCategory(4);
